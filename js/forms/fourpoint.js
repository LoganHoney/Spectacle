...
export const FOURPOINT = {
  ...
  sections: [
    ...
    // ------------------------------------------------------------ ELECTRICAL
    {
      ...
      tabs: [{ key: 'main', label: 'Main Panel' }, { key: 'second', label: 'Second Panel' }],
      fields: [
        { id: 'elec_main_type', label: 'Type', type: 'radio', width: 'half', group: 'main',
          options: [{ key: 'Circuit breaker', label: 'Circuit breaker' }, { key: 'Fuse', label: 'Fuse' }] },
        { id: 'elec_main_amps', label: 'Total Amps', type: 'number', width: 'half', group: 'main' },
        { id: 'elec_main_sufficient', label: 'Is amperage sufficient for current usage?', type: 'radio', width: 'half', group: 'main',
          options: YN.map((k) => ({ key: k, label: k })) },
        { id: 'elec_main_sufficient_explain', label: 'If no, explain', type: 'text', width: 'half', group: 'main', showIf: ['elec_main_sufficient', ['No']] },
        { id: 'elec_second_type', label: 'Type', type: 'radio', width: 'half', group: 'second',
          options: [{ key: 'Circuit breaker', label: 'Circuit breaker' }, { key: 'Fuse', label: 'Fuse' }, { key: 'N/A', label: 'N/A — no second panel' }] },
        { id: 'elec_second_amps', label: 'Total Amps', type: 'number', width: 'half', group: 'second' },
        { id: 'elec_second_sufficient', label: 'Is amperage sufficient?', type: 'radio', width: 'half', group: 'second',
        ...
        { id: 'elec_main_age', label: 'Panel age (years)', type: 'number', width: 'third', group: 'main' },
        { id: 'elec_main_updated', label: 'Year last updated', type: 'number', width: 'third', group: 'main' },
        { id: 'elec_main_brand', label: 'Brand/model', type: 'text', width: 'third', group: 'main' },
        { id: 'elec_second_age', label: 'Panel age (years)', type: 'number', width: 'third', group: 'second' },
        { id: 'elec_second_updated', label: 'Year last updated', type: 'number', width: 'third', group: 'second' },
        { id: 'elec_second_brand', label: 'Brand/model', type: 'text', width: 'third', group: 'second' },
    ...
    // ----------------------------------------------------------------- HVAC
    {
      ...
      fields: [
        ...
        { id: 'hvac_last_service', label: 'Year of last HVAC servicing/inspection', type: 'number', width: 'half' },
