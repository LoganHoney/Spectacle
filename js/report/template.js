...
function build() {
  return [
    ...
    S('Site & Grounds', 'Grading, drainage, walkways and site features that affect the structure.', [
      ['Site grading / slope away from structure', 'condition', null, '', null, 'Grading & Drainage'],
      ['Driveway & walkways', 'condition', null, '', null, 'Driveway & Walkways'],
      ['Retaining walls'],
      ['Vegetation clearance from structure', 'condition', null, '', null, 'Vegetation & Fencing'],
      ['Surface drainage / standing water', 'condition', null, '', null, 'Grading & Drainage'],
      ['Fencing & gates', 'condition', null, '', null, 'Vegetation & Fencing'],
    ...
    S('Roof', 'Roof covering, drainage, flashing and penetrations.', [
      ...
      ['Skylights', 'condition', null, '', null, 'Flashing & Drainage'],
      ['Gutters & downspouts', 'condition', null, '', null, 'Flashing & Drainage'],
      ['Fascia & soffit', 'condition', null, '', null, 'Flashing & Drainage'],
    ...
    S('Exterior', 'Wall covering, trim, openings and attached components.', [
      ['Wall covering material', 'select', ['Stucco over block', 'Stucco over frame', 'Vinyl siding', 'Fiber cement', 'Wood siding', 'Brick veneer', 'Painted block', 'Other'], '', null, 'Wall Covering'],
      ['Wall covering condition', 'condition', null, '', null, 'Wall Covering'],
      ['Trim & fascia', 'condition', null, '', null, 'Windows, Doors & Trim'],
      ['Exterior doors', 'condition', null, '', null, 'Windows, Doors & Trim'],
      ['Windows', 'condition', null, '', null, 'Windows, Doors & Trim'],
      ['Window / door caulk & sealant', 'condition', null, '', null, 'Windows, Doors & Trim'],
      ['Soffit & eave venting'],
      ['Exterior wall penetrations sealed'],
      ['Porches, decks & balconies', 'condition', null, '', null, 'Porches & Attachments'],
    ...
    S('Structure & Foundation', 'Foundation, framing and visible structural components.', [
      ['Foundation type', 'select', ['Slab on grade', 'Stem wall', 'Crawlspace', 'Pier & beam', 'Basement'], '', null, 'Foundation'],
      ['Foundation condition', 'condition', null, '', null, 'Foundation'],
      ['Visible cracking', 'select', ['None observed', 'Hairline / cosmetic', 'Moderate', 'Significant — evaluation recommended'], '', null, 'Foundation'],
      ['Wall structure', 'select', ['Concrete block (CBS)', 'Wood frame', 'Block below / frame above', 'Steel frame', 'Other'], '', null, 'Framing'],
      ['Floor structure', 'condition', null, '', null, 'Framing'],
      ['Ceiling / roof framing', 'condition', null, '', null, 'Framing'],
      ['Evidence of settlement or movement', 'yesno', null, '', null, 'Framing'],
      ['Evidence of wood-destroying organism damage', 'yesno', null, 'Report only — a WDO inspection is a separate licensed service.', null, 'Framing'],
    ...
    S('Attic, Insulation & Ventilation', null, [
      ...
      ['Roof sheathing / decking', 'condition', null, '', null, 'Attic Structure'],
      ['Truss / rafter framing', 'condition', null, '', null, 'Attic Structure'],
      ['Evidence of moisture intrusion', 'yesno', null, '', null, 'Attic Structure'],
      ['Insulation type', 'select', ['Blown fiberglass', 'Blown cellulose', 'Batt fiberglass', 'Spray foam', 'None observed'], '', null, 'Insulation'],
      ['Approximate insulation depth (inches)', 'number', null, '', null, 'Insulation'],
      ['Insulation condition & coverage', 'condition', null, '', null, 'Insulation'],
      ['Attic ventilation', 'condition', null, '', null, 'Ventilation'],
      ['Exhaust fans terminate to exterior', 'yesno', null, '', null, 'Ventilation'],
      ['Attic notes', 'narrative'],
    ]),

    S('Electrical', 'Service, distribution, and representative devices.', [
      ['Service entrance', 'select', ['Overhead', 'Underground'], '', null, 'Service & Devices'],
      ['Service amperage', 'select', ['60 amp', '100 amp', '125 amp', '150 amp', '200 amp', '300 amp', '400 amp', 'Undetermined'], '', 'elec_amps', 'Service & Devices'],
      ['Service voltage', 'select', ['120/240V single phase', '120/208V', 'Other'], '', null, 'Service & Devices'],
      ['Main panel manufacturer', 'text', null, '', 'elec_panel_brand', 'Electrical Panel'],
      ['Main panel location', 'text', null, '', 'elec_panel_location', 'Electrical Panel'],
      ['Electric meter location', 'text', null, '', 'elec_meter_location', 'Electrical Panel'],
      ...
      ['Grounding & bonding', 'condition', null, '', null, 'Service & Devices'],
      ['GFCI protection where required', 'condition', null, '', null, 'Wiring & Safety'],
      ['AFCI protection where required', 'condition', null, '', null, 'Service & Devices'],
      ['Smoke & CO alarms', 'condition', null, '', null, 'Wiring & Safety'],
      ['Representative receptacles & switches', 'condition', null, '', null, 'Service & Devices'],
      ['Light fixtures & ceiling fans', 'condition', null, '', null, 'Service & Devices'],
    ...
    S('Plumbing', 'Supply, drainage, fixtures and water heating.', [
      ...
      ['Main shutoff location', 'text', null, '', 'water_shutoff_location'],
      ...
      ['Drain / waste / vent material', 'select', ['PVC', 'ABS', 'Cast iron', 'Galvanized steel', 'Mixed'], '', null, 'Drain, Waste & Sewage'],
      ...
      ['Sewage disposal', 'select', ['Public sewer', 'Septic system'], '', null, 'Drain, Waste & Sewage'],
      ['Fuel gas system & shutoff', 'condition', null, '', null, 'Drain, Waste & Sewage'],
    ...
    S('Interior', 'Representative rooms, surfaces and components.', [
      ['Ceilings', 'condition', null, '', null, 'Surfaces'],
      ['Walls', 'condition', null, '', null, 'Surfaces'],
      ['Floors', 'condition', null, '', null, 'Surfaces'],
      ['Interior doors', 'condition', null, '', null, 'Openings & Safety'],
      ['Windows — operation & glazing', 'condition', null, '', null, 'Openings & Safety'],
      ['Stairs, railings & guards', 'condition', null, '', null, 'Openings & Safety'],
      ['Fireplace / chimney', 'condition', null, '', null, 'Openings & Safety'],
    ...
    S('Kitchen & Appliances', 'Built-in appliances operated in normal cycles only.', [
      ['Cabinets & countertops', 'condition', null, '', null, 'Cabinets & Counters'],
      ['Sink & faucet', 'condition', null, '', null, 'Cabinets & Counters'],
      ['Garbage disposal', 'condition', null, '', null, 'Appliances'],
      ['Dishwasher', 'condition', null, '', null, 'Appliances'],
      ['Range / cooktop', 'condition', null, '', null, 'Appliances'],
      ['Oven', 'condition', null, '', null, 'Appliances'],
      ['Range hood / exhaust', 'condition', null, '', null, 'Appliances'],
      ['Microwave (built-in)', 'condition', null, '', null, 'Appliances'],
      ['Refrigerator', 'condition', null, '', null, 'Appliances'],
    ...
    S('Bathrooms', null, [
      ...
      ['Toilets', 'condition', null, '', null, 'Fixtures'],
      ['Sinks', 'condition', null, '', null, 'Fixtures'],
      ['Shower/Tub', 'condition', null, '', null, 'Fixtures'],
      ['Tub / shower surround & caulk', 'condition', null, '', null, 'Fixtures'],
      ['Ventilation — fan or window', 'condition', null, '', null, 'Ventilation & Moisture'],
      ['Bathroom GFCI protection'],
      ['Evidence of moisture damage', 'yesno', null, '', null, 'Ventilation & Moisture'],
      ['Bathroom notes', 'narrative'],
    ]),

    S('Laundry', null, [
      ['Laundry location', 'text'],
      ['Washer supply valves & drain', 'condition', null, '', null, 'Laundry'],
      ['Dryer power supply', 'condition', null, '', null, 'Laundry'],
      ['Dryer exhaust duct & termination', 'condition', null, '', null, 'Laundry'],
      ['Laundry notes', 'narrative'],
    ]),

    S('Garage & Carport', null, [
      ['Garage type', 'select', ['Attached', 'Detached', 'Carport', 'None']],
      ['Vehicle door(s) condition', 'condition', null, '', null, 'Doors & Openers'],
      ['Automatic opener & safety reverse', 'condition', null, '', null, 'Doors & Openers'],
      ['Photo-eye sensors', 'condition', null, '', null, 'Doors & Openers'],
      ['Fire separation — wall & ceiling', 'condition', null, '', null, 'Structure & Electrical'],
      ['Self-closing door to living space', 'condition', null, '', null, 'Structure & Electrical'],
      ['Floor & slab', 'condition', null, '', null, 'Structure & Electrical'],
      ['Garage electrical & GFCI', 'condition', null, '', null, 'Structure & Electrical'],
      ['Garage notes', 'narrative'],
    ]),

    S('Pool & Spa', 'Included only when contracted. Mark items Not Present when no pool exists.', [
      ['Pool present', 'yesno'],
      ['Pool shell / surface', 'condition', null, '', null, 'Pool Equipment'],
      ['Deck & coping', 'condition', null, '', null, 'Pool Equipment'],
      ['Pump, filter & plumbing', 'condition', null, '', null, 'Pool Equipment'],
      ['Heater', 'condition', null, '', null, 'Pool Equipment'],
      ['Electrical bonding & GFCI', 'condition', null, '', null, 'Pool Equipment'],
      ['Safety barrier / enclosure / gate', 'condition', null, '', null, 'Safety Barrier'],
